...
<table width="100%" border="0">
  <tr>
	...
	<tr>
		<td>
			<table align="center">
			<tr><td><form name="form1" method="POST" action="admin_co_space_photo_save.php?co_id=<?php echo"$co_id"?>" enctype="multipart/form-data">
					<?php
					$result=mysql_query("SELECT * from co_space");
					$row=mysql_fetch_assoc($result);
					$co_picture=$row["co_picture"];

					echo "<img src='$co_picture' width='800'>";
?>
			</td></tr>
					<tr>
							<td><input name="co_picture" type="file" id="co_picture" maxlength="20"></td>
						</tr>
							<tr>
