...
<table width="100%" border="0">
  <tr>
	...
	<tr>
		<td>
			<table align="center">
			<tr><td><form name="form1" method="POST" action="admin_banner_save.php" enctype="multipart/form-data">
					<?php
					$result=mysql_query("SELECT * from banner where ban_id=1");
					$row=mysql_fetch_assoc($result);
					$ban_name=$row["ban_name"];
...
?>
					...
					<tr>
							<td><input name="ban_name" type="file" id="ban_name" maxlength="20"></td>
						</tr>
							<tr>
