...
<body>
	...
	$result = mysqli_query($conn, "UPDATE menu set gmenu_id='$gmenu_id',menu_name='$menu_name',menu_link='$menu_link',menu_target='$menu_target',menu_status='$menu_status',menu_memo='$menu_memo' WHERE menu_id='$menu_id'");
	if (!$result) {
