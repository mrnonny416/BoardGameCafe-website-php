...
<table width="100%" border="0">
  <tr>
      ...
      <div class="container-fluid">
        ...
        <a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-user"></span> <?php echo $user_name; ?>
          <ul class="dropdown-menu" role="menu" aria-labelledby="menu1">
     		 ...
     		 <li role="divider">
     		 <li role="presentation"><a role="menuitem" tabindex="-1" href="#">แก้ไขข้อมูล</a></li>
	...
	<div class="panel panel-info">
	      <div class="panel-heading"><a href="admin_gmenu.php">ราการเมนูหลัก</a> >> เพิ่มแถบเมนูหลัก</div>
				  <form id="form1" name="form1" method="POST" action="admin_gmenu_insert_save.php" enctype="multipart/form-data">
	      <div class="panel-body">
									<div class="input-group">
      								<span class="input-group-addon">รายการเมนูหลัก</span>
      								<input name="gmenu_name"  id="gmenu_name" type="text" class="form-control"  placeholder="">
    						</div>
<br>
							<div class="input-group">
