    ...
    <td>
			<table width="95%" border="4" align="center">
				<tr align="center" border="4">
					<?php $result5=mysql_query("SELECT * from co_space");
					$row5=mysql_fetch_assoc($result5);
					$co_id=$row5["co_id"];
					$co_text=$row5["co_text"];
					$co_picture=$row5["co_picture"];
					 ?>
				<td>
					<img src="<?php echo $co_picture ?>" width="100%" class="img-thumbnail">	แก้ไขรูปภาพ<a href="admin_co_space_photo.php?co_id=<?php echo"$co_id"?>"><img src="images/edit.png" width="35"></a>
				</td>
			</tr>
			<tr>
				<td bgcolor="#0187C9">
			<font color="#FFF" size="5"><?php echo $co_text ?></font>
				</td>

				</tr>
				<tr>
					<td align="center">
						แก้ไขข้อความ<a href="admin_co_space_text.php?co_id=<?php echo"$co_id"?>"><img src="images/edit.png" width="35"></a>
					</td>
				</tr>
			</table>
