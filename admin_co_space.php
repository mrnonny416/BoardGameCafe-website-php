			...
			<td>
				<table width="95%" border="4" align="center">
					<tr align="center" border="4">
						<?php $result5 = mysqli_query($conn, "SELECT * from co_space");
						...
						?>
						<td>
							<img src="<?php echo $co_picture ?>" width="100%" class="img-thumbnail"> แก้ไขรูปภาพ<a
								href="admin_co_space_photo.php?co_id=<?php echo "$co_id" ?>"><img src="images/edit.png"
									width="35"></a>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td align="center">
							แก้ไขข้อความ<a href="admin_co_space_text.php?co_id=<?php echo "$co_id" ?>"><img
