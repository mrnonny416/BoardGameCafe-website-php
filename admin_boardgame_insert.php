...
<table width="100%" border="0">
  <tr>
	...
	<div class="panel panel-info">
	      <div class="panel-heading"><a href="admin_boardgame.php">รายการบอร์ดเกมส์</a> >> เพิ่มรายการบอร์เกมส์</div>
				  <form id="form1" name="form1" method="POST" action="admin_boardgame_insert_save.php" enctype="multipart/form-data">
	      <div class="panel-body">
					<div class="input-group">
							<span class="input-group-addon">ชื่อเกมส์</span>
							<input name="game_name"  id="game_name" type="text" class="form-control"  placeholder="">
				</div>
<br>
									<div class="input-group">
      								<span class="input-group-addon">เวลาที่ใช้</span>
      								<input name="game_time"  id="game_time" type="text" class="form-control"  placeholder="">
    						</div>
<br>
										<div class="input-group">
											<span class="input-group-addon">rate อายุ</span>
										<input name="game_rate"  id="game_rate" type="text" class="form-control"  placeholder="">
										</div>
<br>
											<div class="input-group">
...
<br>
	      				...
	      				<span class="input-group-addon">ข้อมูล</span>
												<input name="game_info"  id="game_info" type="text" class="form-control"  placeholder="">
	    				</div>
<br>
							<div class="input-group">
							...
							<br>
																<div class="input-group">
							      								...
							      								<input name="game_memo"  id="game_memo" type="text" class="form-control"  placeholder="">
							    						</div></div>
							<center>
