            ...
            <td>
                <div class="container">
                    <div class="panel panel-info">
                        <div class="panel-heading"><a href="admin_boardgame.php">รายการบอร์ดเกมส์</a> >>
                            เพิ่มรายการบอร์เกมส์</div>
                        <form id="form1" name="form1" method="POST" action="admin_boardgame_insert_save.php"
                            ...
                            <div class="panel-body">
                                ...
                                <div class="input-group">
                                    ...
                                    <input name="game_man" id="game_man" type="text" class="form-control"
                                        placeholder="">
                                </div>
                                <br>
                                <div class="input-group">
