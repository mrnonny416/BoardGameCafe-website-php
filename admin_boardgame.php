  ...
  <tr>
    <td>
						<table width="90%" align="center" border="0">
							...
							<td><a href="admin_boardgame_insert.php"><img src="images/add.png" width="35">เพิ่มรายการบอร์ดเกมส์
							</td></tr>
								<tr>
									<td colspan="2">
									...
									<?php
									$result2= mysql_query("SELECT * from boardgame");
									...
									<tr  align="center">
										...
										<td align="center">
											<a href="admin_boardgame_update.php?game_name=<?php echo $game_name; ?>"><img src="images/edit.png" width="35"></a>
											<a href="admin_boardgame_delete_ok.php?game_name=<?php echo $game_name; ?>" OnClick="if(confirm('โปรดยืนยันการลบข้อมูล'))return true; else return false;"><img src="images/del.png" width="35"></a>
										</td>
								</tr>
