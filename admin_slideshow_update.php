...
<body>
	<table width="100%" border="0">
		...
		<tr align="center">
			<td>เปลี่ยนรูปภาพ banner slideshow ที่
				<?php echo $spic_id; ?>
			</td>
		</tr>
		<tr>
			<td>
				<table align="center">
					<tr>
						<td>
							<form name="form1" method="POST" action="admin_slideshow_update_save.php"
								enctype="multipart/form-data">
								<div class="alert alert-warning">
									<strong>Warning!</strong> ขนาดรูปภาพ <a href="#" class="alert-link">width = 360 x
										height = 200</a>.
								</div>
								<?php
								$result2 = mysqli_query($conn, "SELECT * from picslide where spic_id='$spic_id'");
