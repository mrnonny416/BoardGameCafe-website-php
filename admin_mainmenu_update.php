	...
	<table width="100%" border="0">
		...
		<tr>
			<td>
				<table align="center">
					<tr>
						<td>
							<form name="form1" method="POST" action="admin_mainmenu_update_save.php"
								enctype="multipart/form-data">
								<?php
								$result2 = mysqli_query($conn, "SELECT * from mainmenu where mmenu_id='$mmenu_id'");
								$row2 = mysqli_fetch_assoc($result2);

								$mmenu_id = $row2["mmenu_id"];
								$mmenu_name = $row2["mmenu_name"];

								echo "<img src='$mmenu_name' width='800'>";
								?>
						</td>
					</tr>
					<tr>
						<td><input name="mmenu_name" type="file" id="mmenu_name" maxlength="200"></td>
					</tr>
					<tr>
						<?php //echo "$spic_id"; ?>
						<input type="hidden" id="mmenu_id" name="mmenu_id" value="<?php echo $mmenu_id; ?>">
		...
		<tr>
			<td align="center" bgcolor="#33CCCC">
				<font color="#FFFFFF">Decelopment by : Tawee Sopapan,Information Techmology.Chiangrai Vocarional
					College. @Copyright 2017 </font>
			</td>
		</tr>
	</table>
</body>
