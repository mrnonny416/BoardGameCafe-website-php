...
<body>
	...
	<tr align="center">
		<td>เปลี่ยนรูปภาพ เมนูใหญ่ ที่ <?php echo $mmenu_id; ?></td>
		</tr>
	<tr>
		<td>
			<table align="center">
			<tr><td><form name="form1" method="POST" action="admin_mainmenu_update_save.php" enctype="multipart/form-data">
					<?php
					$result2= mysql_query("SELECT * from mainmenu where mmenu_id='$mmenu_id'");
