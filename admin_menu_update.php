			...
			<td>
				<div class="container">
					<div class="panel panel-info">
						...
						<form id="form1" name="form1" method="POST" action="admin_menu_update_save.php"
							enctype="multipart/form-data">
							<?php
							//echo"$menu_id";
							$result1 = mysqli_query($conn, "SELECT * from menu where menu_id='$menu_id'");
								...
								<div class="panel-body">
									<div class="input-group">
										...
										<select class="form-control" name="gmenu_id" id="gmenu_id">
											<?php
											$result = mysqli_query($conn, "SELECT * from group_menu");
											while ($row = mysqli_fetch_assoc($result)) {
												?>
									...
									<div class="input-group">
										...
										<input name="menu_name" id="menu_name" type="text" class="form-control"
											placeholder="" value="<?php echo $menu_name; ?>">
									</div>
									<br>
									<div class="input-group">
										<span class="input-group-addon">การเชื่อมโยงไฟล์</span>
										<input name="menu_link1" id="menu_link1" type="file" class="form-control"
											placeholder="">
										<span class="input-group-addon">URL Upload</span>
										<input name="menu_link2" id="menu_link2" type="text" class="form-control"
											placeholder="" value="<?php echo $menu_link; ?>">
									</div>
									<br>
									<div class="input-group">
										<span class="input-group-addon">ให้แสดงหน้าเว็บใหม่</span>
										<?php if ($menu_target == "Y") { ?>
											<input type="radio" name="menu_target" id="menu_target" value="target='_blank'"
												checked>ใช่
											<input type="radio" name="menu_target" id="menu_target"
												value="target='_self'">ไม่ไช่
										<?php } else { ?>
											<input type="radio" name="menu_target" id="menu_target" value="target='_blank'">ใช่
											<input type="radio" name="menu_target" id="menu_target" value="target='_self'"
												checked>ไม่ไช่
										<?php } ?>
									</div>
									<br>
									...
									<div class="input-group">
										...
										<input name="menu_memo" id="menu_memo" type="text" class="form-control"
											placeholder="" value="<?php echo $menu_memo; ?>">
									</div>
								</div>
								<center>
								<?php } ?>
