  ...
  <tr>
	...
	<div class="panel panel-info">
	      <div class="panel-heading"><a href="admin_gmenu.php">ราการเมนูหลัก</a> >> แก้ไขแถบเมนูหลัก</div>
				  <form id="form1" name="form1" method="POST" action="admin_gmenu_update_save.php" enctype="multipart/form-data">
						<?php
	      ...
	      <div class="panel-body">
									<div class="input-group">
      								...
      								<input name="gmenu_name"  id="gmenu_name" type="text" class="form-control"  placeholder="" value="<?php echo $gmenu_name; ?>">
    						</div>
<br>
							<div class="input-group">
	      				<span class="input-group-addon">แสดงในส่วนของคนทั่วไป</span>&nbsp;&nbsp;&nbsp;
								...
								<?php }else{ ?>
									...
									<input type="radio" name="gmenu_status"  id="gmenu_status" value="N" checked>แสดง user
								<?php } ?>
