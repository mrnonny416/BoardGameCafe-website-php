			...
			<td>
				<table align="center">
					<tr>
						<td>
							<form name="form1" method="POST"
								action="admin_co_space_text_save.php?co_id=<?php echo $co_id ?>"
								enctype="multipart/form-data">
								<?php
								$result = mysqli_query($conn, "SELECT * from co_space where co_id='$co_id'");
								$row = mysqli_fetch_assoc($result);
								$co_text = $row["co_text"];
								?>
						</td>
					...
					<tr>
						<td width="600">
							<div class="input-group">
								...
								<textarea type="text" class="form-control" placeholder="" name="co_text" id="co_text"
									rows="10"><?php echo $co_text ?></textarea>
							</div>
						</td>
					</tr>
					<tr>
					...
					<tr>
						<td>
							"&nbsp;" เว้นวรรค
							&lt; ใช้แทน < (less than) &gt; ใช้แทน> (greater than)
								&amp; ใช้แทน & (ampersand)
						</td>
					</tr>
				</table>
