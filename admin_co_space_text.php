...
<table width="100%" border="0">
  <tr>
	...
	<tr align="center">
		<td>เปลี่ยนข้อความ</td>
		</tr>
	<tr>
		<td>
			<table align="center">
			<tr><td><form name="form1" method="POST" action="admin_co_space_text_save.php?co_id=<?php echo $co_id ?>" enctype="multipart/form-data">
					<?php
					$result=mysql_query("SELECT * from co_space where co_id='$co_id'");
					$row=mysql_fetch_assoc($result);
					$co_text=$row["co_text"];
?>
			</td></tr>
					<tr>
							...
							<span class="input-group-addon">ข้อความ</span>
								<textarea type="text" class="form-control" placeholder="" name="co_text" id="co_text" rows="10"><?php echo $co_text ?></textarea>
							</div>
							</td>
						</tr>
							<tr>
								<td><input type="submit" value="เปลี่ยนข้อความ" class="btn btn-success"></td>
							</tr>
							<tr>
								<td>
							"&nbsp;" เว้นวรรค
