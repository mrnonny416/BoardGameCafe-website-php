  ...
  <tr>
	...
	<div class="panel panel-info">
	      <div class="panel-heading"><a href="admin_event.php">รายการกิจกรรม</a> >> เพิ่มรายการเพิ่ม</div>
				  <form id="form1" name="form1" method="POST" action="admin_event_insert_save.php" enctype="multipart/form-data">
...
<br>
									<div class="input-group">
      								...
      								<textarea name="event_place"  id="event_place" type="text" class="form-control"  placeholder="" rows="6"></textarea>
    						</div>
<br>
										<div class="input-group">
...
<br>
	      				...
	      				<span class="input-group-addon">หมายเหตุ</span>
												<input name="event_memo"  id="event_memo" type="text" class="form-control"  placeholder="">
	    				</div>
</div>
							<center>
