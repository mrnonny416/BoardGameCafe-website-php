			...
			<td>
				<div class="container">
					<div class="panel panel-info">
						<div class="panel-heading"><a href="admin_menu.php">ราการเมนูย่อย</a> >> เพิ่มแถบเมนูย่อย</div>
						<form id="form1" name="form1" method="POST" action="admin_menu_insert_save.php"
							...
							<div class="panel-body">
								...
								<br>
								<div class="input-group">
									<span class="input-group-addon">รายการเมนูย่อย</span>
