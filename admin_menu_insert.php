  ...
  <tr>
	...
	<div class="panel panel-info">
	      <div class="panel-heading"><a href="admin_menu.php">ราการเมนูย่อย</a> >> เพิ่มแถบเมนูย่อย</div>
				  <form id="form1" name="form1" method="POST" action="admin_menu_insert_save.php" enctype="multipart/form-data">
...
<br>
									<div class="input-group">
      								...
      								<input name="menu_name"  id="menu_name" type="text" class="form-control"  placeholder="">
    						</div>
<br>
										<div class="input-group">
      								...
      								<input name="menu_link2"  id="menu_link2" type="text" class="form-control"  placeholder="">
										</div>
<br>
											<div class="input-group">
	      				...
	      				<span class="input-group-addon">แสดงในส่วนของคนทั่วไป</span>&nbsp;&nbsp;&nbsp;
							...
							<br>
																<div class="input-group">
							      								...
							      								<input name="menu_memo"  id="menu_memo" type="text" class="form-control"  placeholder="">
							    						</div></div>
							<center>
