...
$result=mysql_query("INSERT into user values('$user_username','$user_password','$user_name','$user_address','$user_tel','$user_email','$user_picture','$user_type','$user_status','$user_memo')");
if(!$result){
