...
<table width="100%" border="0">
  <tr>
	...
	<tr>
		<td >
		<?php	$result2= mysql_query("SELECT * from boardgame where game_name='$game_name'");
	...
	<div class="panel panel-info">
	      <div class="panel-heading"><a href="admin_boardgame.php">รายการบอร์ดเกมส์</a> >> แก้ไขข้อมูล เกมส์ :<?php echo $game_name ?></div>
				  <form id="form1" name="form1" method="POST" action="admin_boardgame_update_save.php" enctype="multipart/form-data">
	      <div class="panel-body">
					<div class="input-group">
							<span class="input-group-addon">ชื่อเกมส์</span>
							<input name="game_name"  id="game_name" type="text" class="form-control"  placeholder="" value="<?php echo $game_name ?>" readonly>
				</div>
<br>
									<div class="input-group">
      								<span class="input-group-addon">เวลาที่ใช้</span>
      								<input name="game_time"  id="game_time" type="text" class="form-control"  placeholder="" value="<?php echo $game_time?>">
    						</div>
<br>
										<div class="input-group">
											<span class="input-group-addon">rate อายุ</span>
										<input name="game_rate"  id="game_rate" type="text" class="form-control"  placeholder="" value="<?php echo $game_rate ?>">
										</div>
<br>
											<div class="input-group">
												<span class="input-group-addon">จำนวนคน</span>
											<input name="game_man"  id="game_man" type="text" class="form-control"  placeholder="" value="<?php echo $game_man ?>">
											</div>
<br>
							<div class="input-group">
	      				<span class="input-group-addon">ข้อมูล</span>
												<input name="game_info"  id="game_info" type="text" class="form-control"  placeholder="" value="<?php echo $game_info ?>">
	    				</div>
<br>
							<div class="input-group">
								<span class="input-group-addon">รูปภาพ</span>
												<input name="game_picture"  id="game_picture" type="file" class="form-control"  placeholder="">
								    				</div>
							<br>
																<div class="input-group">
							      								<span class="input-group-addon">หมายเหตุ</span>
							      								<input name="game_memo"  id="game_memo" type="text" class="form-control"  placeholder="" value="<?php echo $game_memo ?>">
							    						</div></div>
							<center>
