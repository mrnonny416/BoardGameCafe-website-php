			...
			<td>
				<table width="90%" align="center" border="0">
					<tr>
						...
						<td><a href="admin_gmenu_insert.php"><img src="images/add.png"
									width="35">เพิ่มรายการเมนูหลัก</a>
						</td>
					</tr>
					<tr>
						<td colspan="2">
							<table class="table table-striped" width="100%" align="center" border="0">
								...
								<?php
								$result1 = mysqli_query($conn, "SELECT * from group_menu");
								while ($row1 = mysqli_fetch_assoc($result1)) {
									...
									<tr>
										...
										<td align="center">
											<?php echo $row1["gmenu_name"]; ?>
										</td>
										<td align="center">
											<?php echo $row1["gmenu_status"]; ?>
										</td>
										<td align="center"><a
												href="admin_gmenu_update.php?gmenu_id=<?php echo $gmenu_id; ?>"><img
													src="images/edit.png" width="35"></a>
											<a href="admin_gmenu_delete_ok.php?gmenu_id=<?php echo $gmenu_id; ?>"
