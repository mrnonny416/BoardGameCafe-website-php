    ...
    <td>
						<table width="90%" align="center" border="0">
									<tr><td width="60%">
  										...
  										<li ><a href="admin_menu.php">ราการเมนูย่อย</a></li>
  									<li class="active"><a href="admin_gmenu.php">ราการเมนูหลัก</a></li>
									</ul>
								</td>
							<td><a href="admin_gmenu_insert.php"><img src="images/add.png" width="35">เพิ่มรายการเมนูหลัก</a>
							</td></tr>
								<tr>
									<td colspan="2">
									<table class="table table-striped" width="100%" align="center" border="0" >
										<tr align="center">
											<td>รหัสเมนูหลัก</td>
											<td>รายการเมนูหลัก</td>
											<td>สถานะ</td>
											<td>การจัดการ</td>
									</tr>
									<?php
									$result1= mysql_query("SELECT * from group_menu");
									while($row1=mysql_fetch_assoc($result1))
									{
										$gmenu_id=$row1["gmenu_id"];
									?>
									<tr>
										<td align="center"><?php echo $gmenu_id; ?></td>
										<td align="center"><?php echo $row1["gmenu_name"]; ?></td>
										<td align="center"><?php echo $row1["gmenu_status"]; ?></td>
										<td align="center"><a href="admin_gmenu_update.php?gmenu_id=<?php echo $gmenu_id; ?>"><img src="images/edit.png" width="35"></a>
											<a href="admin_gmenu_delete_ok.php?gmenu_id=<?php echo $gmenu_id; ?>" OnClick="if(confirm('โปรดยืนยันการลบข้อมูล'))return true; else return false;"><img src="images/del.png" width="35"></a>
								</tr>
