		...
		<tr>
			<td>
				<table width="95%" height="90%" align="center" border="0">
					<!--.......................................................................................................-->
					<tr>
						<td rowspan="2" height="745" width="40%" align="right" valign="middle">
							<?php
							$result5 = mysqli_query($conn, "SELECT * from mainmenu where mmenu_id='1'");
							$row5 = mysqli_fetch_assoc($result5);
							$mmenu_name1 = $row5["mmenu_name"];
							$mmenu_id1 = $row5["mmenu_id"];
							?>

							<img src="<?php echo "$mmenu_name1"; ?>" class="image" height="95%" width="90%">
							<a href="admin_mainmenu_update.php?mmenu_id=<?php echo $mmenu_id1; ?>"><img
									src="images/edit.png" width="35"></a>
						</td>
						<!--.......................................................................................................-->
						<?php
						$result3 = mysqli_query($conn, "SELECT * from mainmenu where mmenu_id='2'");
						$row3 = mysqli_fetch_assoc($result3);
						$mmenu_name2 = $row3["mmenu_name"];
						$mmenu_id2 = $row3["mmenu_id"];
						?>
						<td height="372" width="60%" align="center" valign="middle">
							<img src="<?php echo "$mmenu_name2"; ?>" class="image" height="90%" width="90%">
							<a href="admin_mainmenu_update.php?mmenu_id=<?php echo $mmenu_id2; ?>"><img
									src="images/edit.png" width="35"></a>
						</td>
					</tr>
					<!--.......................................................................................................-->
					<?php
					$result4 = mysqli_query($conn, "SELECT * from mainmenu where mmenu_id='3'");
					$row4 = mysqli_fetch_assoc($result4);
					$mmenu_name3 = $row4["mmenu_name"];
					$mmenu_id3 = $row4["mmenu_id"];
					?>
					<tr>
						<td height="372" align="center" valign="middle">
							<img src="<?php echo "$mmenu_name3"; ?>" class="image" height="90%" width="90%">
							<a href="admin_mainmenu_update.php?mmenu_id=<?php echo $mmenu_id3; ?>"><img
									src="images/edit.png" width="35"></a>
						</td>
						<!--.......................................................................................................-->
					</tr>
