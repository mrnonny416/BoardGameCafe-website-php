				...
				<div class="container">
					<div class="panel panel-info">
						...
						<form id="form1" name="form1" method="POST"
							action="admin_event_update_save.php?event_id=<?php echo "$event_id" ?>"
							...
							<div class="panel-body">
								...
								<?php $result6 = mysqli_query($conn, "SELECT * from event where event_id='$event_id'");
								...
								<div class="input-group">
									...
									<textarea name="event_place" id="event_place" type="text" class="form-control"
										placeholder="" rows="6"><?php echo "$event_place" ?></textarea>
								</div>
								<br>
								<div class="input-group">
								...
								<div class="input-group">
									...
									<input name="event_memo" id="event_memo" type="text" class="form-control"
										placeholder="" value="<?php echo " $event_memo" ?>">
								</div>
							</div>
							<center>
