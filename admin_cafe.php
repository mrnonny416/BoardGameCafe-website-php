...
<table width="100%" border="0">
  ...
  <tr>
	...
	<tr><td width="100%" border="1"><table width="80%" align="center"><tr><td width="100%"><form name="form1" method="POST" action="admin_map_save.php" enctype="multipart/form-data">
		...
		$map_id=$row10["map_id"]
		?>
		<input type="text" class="form-control" placeholder="" name="map_name" id="map_name">
		<input type="hidden" class="form-control" placeholder="" name="map_id" id="map_id" value="<?php echo"$map_id" ?>">
				</div>
...
<?php echo"$map_name" ?>
  ...
  <tr>
    <td>
			...
			<a href="admin_cafe_text.php?ctext_id=<?php echo"$ctext_id1"?>"><img src="images/edit.png" width="35"></a>
					</td>
					<td>
			...
			<a href="admin_cafe_photo.php?cphoto_id=<?php echo"$cphoto_id1"?>"><img src="images/edit.png" width="35"></a>
					</td>
				</tr>
				<tr align="center">
					<td  height="420">
			...
			<a href="admin_cafe_photo.php?cphoto_id=<?php echo"$cphoto_id2"?>"><img src="images/edit.png" width="35"></a>
					</td>
			...
			<font color="<?php echo $ctext_font2; ?>"><h1><?php echo $ctext_info2; ?></h1></font>
				<a href="admin_cafe_text.php?ctext_id=<?php echo"$ctext_id2"?>"><img src="images/edit.png" width="35"></a>
					</td>
					<td>
				</tr>
				<tr align="center">
					...
					<img src="<?php echo $cphoto_name3; ?>" width="100%">
						<a href="admin_cafe_photo.php?cphoto_id=<?php echo"$cphoto_id3"?>"><img src="images/edit.png" width="35"></a>
					</td>
				</tr>
			</table>
