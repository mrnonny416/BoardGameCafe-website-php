						...
						<table width="90%" align="center" border="0">
							...
							<td><a href="admin_menu_insert.php"><img src="images/add.png" width="35">เพิ่มรายการเมนูย่อย
								...
								<tr>
									...
									?>
									<tr>
										<td align="center"><?php echo $row2["menu_id"]; ?></td>
										<td><?php
														$gmenu_id=$row2["gmenu_id"];
														$result1= mysql_query("SELECT * from group_menu where gmenu_id='$gmenu_id'");
										...
										<td><?php echo $row2["menu_link"]; ?></td>
										<td><?php echo $row2["menu_target"]; ?></td>
										<td align="center"><?php echo $row2["menu_status"]; ?></td>
										<td><?php echo $row2["menu_memo"]; ?></td>
										<td align="center">
											<a href="admin_menu_update.php?menu_id=<?php echo $menu_id; ?>"><img src="images/edit.png" width="35"></a>
											<a href="admin_menu_delete_ok.php?menu_id=<?php echo $menu_id; ?>" OnClick="if(confirm('โปรดยืนยันการลบข้อมูล'))return true; else return false;"><img src="images/del.png" width="35"></a>
										</td>
								</tr>
